      ...
      complete: (result) => {
        ...
        const filteredData = result.data.filter(
          (item) =>
            ...
            item["ACPSP_OnPotential"] !== undefined &&
            item["ACPSP_OnPotential"] !== null &&
            item["ACPSP_OnPotential"].toString().trim() !== '' &&
            !isNaN(Number(item["ACPSP_OnPotential"]))
        ...
        const dataOn = filteredData.map((item) => Number(item["ACPSP_OnPotential"]));
        ...
        setChartOptions({
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: 'Virtual Distance vs ACPSP',
            },
